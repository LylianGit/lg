...
public class Jeu {
    ...
    */
        ...
        while(Fini != true)
        {
            ...
            for(int i=0; i<listJ.size(); i++) //debut tour joueur
            {
                if(listJ.get(i).estVivant()){
                    ...
                    listJ.get(verifNumVote( sc,  str,  nbJoueurs,  i,  listJ)).Voted();
                }
            ...
            if(x == -1){
                ...
                listJ.get(x).SeMeurt();
                System.out.println("Joueur tué : "+listJ.get(x).getPseudo() +" qui était "+listJ.get(x).getRole().getRole());
                        ...
                        if(listJ.get(i).getRole().getRole() == "Loup"){//debut loup
                            ...
                            do{
                                ...
                                if(carac == 'v'){
                                    ...
                                    ((Sorciere) listJ.get(i).getRole()).utiliserPotionVie(listJ.get(verifNumVote(sc, str, nbJoueurs, i, listJ)));
                                    }else{
                                        System.out.print("\033[H\033[2J");
                                    ...
                                    if(((Sorciere) listJ.get(i).getRole()).getPotionDispoMort()){
                                        ...
                                        ((Sorciere) listJ.get(i).getRole()).utiliserPotionMort(listJ.get(verifNumVote(sc, str, nbJoueurs, i, listJ)));
                                    }
                                    else{
                                        System.out.print("\033[H\033[2J");
    ...
    public static int verifNb(Scanner sc, String str){
        ...
        while(valide == false) {
            ...
            try{
                ...
                System.out.println("Erreur, choisis un chiffre entre "+jmin+" et "+jmax);
            } 
        }
        return numero;
    }

    public static int verifNumVote(Scanner sc, String str, int nbJoueurs, int i, List<Joueur> listJ){
        boolean valide = false;
        int numero = -1;
        while(valide == false) {
            str = sc.nextLine();
